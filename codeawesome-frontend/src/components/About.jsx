...
function About() {
    ...
    <Card.Body >
        ...
        <Card.Link href="https://github.com/DakshDesaiCoder" target="_blank">My Github</Card.Link>
    </Card.Body>
    </Card>
    <Card style={{ width:"18rem",borderRadius:"0px 25px 0px 25px" }} className="cards">
    <Card.Body>
        ...
        <Card.Link href="https://github.com/MananPyJava" target="_blank">My Github</Card.Link>
    </Card.Body>
    </Card>
    <Card style={{width:"18rem",borderRadius:"0px 25px 0px 25px"   }} className="cards">
    <Card.Body>
        ...
        <Card.Link href="https://github.com/TurboCoder21" target="_blank">My Github</Card.Link>
    </Card.Body>
    </Card>
            </Row>
